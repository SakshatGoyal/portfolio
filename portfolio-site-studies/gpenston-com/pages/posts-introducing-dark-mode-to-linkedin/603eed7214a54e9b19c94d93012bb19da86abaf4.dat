...
`,x=document.createElement("style");x.innerHTML=I;document.head.appendChild(x);var f=class extends Promise{constructor(){let n,o;super((r,m)=>{n=r,o=m});s(this,"_state","initial");s(this,"resolve");s(this,"reject");this.resolve=r=>{this._state="fulfilled",n(r)},this.reject=r=>{this._state="rejected",o(r)}}get state(){return this._state}pending(){return this._state="pending",this}isResolved(){return this._state==="fulfilled"||this._state==="rejected"}};f.prototype.constructor=Promise;function i(){return typeof navigator<"u"?navigator:void 0}var O=/Edg\//u;function g(){let e=i();return e?O.test(e.userAgent):!1}var T=/Chrome/u,S=/Google Inc/u;function A(){let e=i();return e?T.test(e.userAgent)&&S.test(e.vendor)&&!g():!1}var y=/AppleWebKit\//u;function k(){let e=i();return e?y.test(e.userAgent)&&!A()&&!g():!1}function j(){return typeof document=="object"}function D(){let e=i();return e?A()&&e.userAgent.toLowerCase().includes("; wv)"):!1}function L(){let e=i();return e?k()&&!e.userAgent.toLowerCase().includes("safari/"):!1}function Z(){return D()||L()}function b(e){let t=window.__framer_editorBarDependencies;if(!t)throw new Error("Dependencies not found");if(t.__version<1||t.__version>3)throw new Error("Unsupported version");let n=t[e];if(!n)throw new Error("Dependency not found");return n}var{createElement:l,memo:G,useCallback:K,useEffect:$,useRef:J,useState:Q,useLayoutEffect:q}=b("react");function ne(e,t,n){let{children:o,...r}=t??{};return n!==void 0&&(r.key=n),l(e,r,o)}function oe(e,t,n){let{children:o,...r}=t??{};return n!==void 0&&(r.key=n),l(e,r,...o)}function ie(e,t){if(e)return;if(typeof t=="function")try{t=t()}catch{t="(assert message threw)"}typeof t=="string"&&t.length>2048&&(t=t.slice(0,2048)+"\u2026");let n=Error(t?"Assertion Error: "+t:"Assertion Error");if(n.stack)try{let o=n.stack.split(`
`);o[1]?.includes("assert")?(o.splice(1,1),n.stack=o.join(`
`)):o[0]?.includes("assert")&&(o.splice(0,1),n.stack=o.join(`
`))}catch{}throw n}function se(e,t){throw t instanceof Error?t:t!==void 0?new Error(String(t)):new Error(e?`Unexpected value: ${e}`:"Application entered invalid state")}export{s as a,w as b,N as c,c as d,W as e,E as f,u as g,d as h,R as i,v as j,f as k,j as l,Z as m,b as n,G as o,K as p,$ as q,J as r,Q as s,ie as t,se as u,ne as v,oe as w};
//# sourceMappingURL=https://app.framerstatic.com/chunk-WMNPBM32.mjs.map
