...
The four original case-study routes are direct transcriptions of the supplied Figma frames. Their imagery is downloaded from the nested nodes in the same file and stored locally; the website does not substitute stock or generated content.
...
The two added studies were edited from supplied project folders rather than transcribed from Figma. Apple Notes were treated as working context, not finished copy. Claims that could not be substantiated by the supplied material were either qualified or omitted.
